  ...
  <section id="main-content-wrapper">
    <div class="container settings-page-wrapper">
      ...
      <ul class="nav nav-tabs settings-tabs" role="tablist">
        ...
        <li class="active"><a href="settings.html">Users</a></li>
        <li><a href="connection1.jsp">Connection</a>
        </li>
      </ul>
      <!-- Tab panes -->
        ...
        <!--Sof Users Content-->
          <div class="users-wrapper">
            <div class="row">
              ...
              <div class="col-md-6 text-right mt-20"><button class="btn btn-sm btn-success"><i class="fas fa-plus"></i>
                  Add User</button></div>
            </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-center">
                        <button class="btn btn-icon btn-primary" data-toggle="tooltip" data-placement="top"
                          title="Edit">
                          <i class="fas fa-edit"></i>
                        </button>

                        <button class="btn btn-icon btn-danger" data-toggle="tooltip" data-placement="top"
                          title="Delete">
